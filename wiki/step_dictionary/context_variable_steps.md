...
**Usage:**
```gherkin
And sg: I save the response field "orderId" to variable "createdOrderId"
```
...
And sg: I have the following request body:
  """
  {"orderId":"{createdOrderId}","status":"cancelled"}
  """
And sg: I use variable "createdOrderId" in the request body
